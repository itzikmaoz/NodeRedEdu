...
<img src="../Chapter%201%20-%20Getting%20Started/Screenshots/node-red-dashboard-install.png" height="500">

3. Pull out a form node on the workspace and double click to edit. 

<img src="../Chapter%201%20-%20Getting%20Started/Screenshots/form1.png" height="500">

  - Group: Add new ui_group, click the pen symbol to the right. 
   - Name the group whatever you like
    
 <img src="../Chapter%201%20-%20Getting%20Started/Screenshots/form2.png">
 
  - Tab: Add new ui_tab, click the pen symbol to the right. 
  - Name the tab whatever you like
  
  <img src="../Chapter%201%20-%20Getting%20Started/Screenshots/form3.png">
  ...
  <img src="../Chapter%201%20-%20Getting%20Started/Screenshots/form4.png">

4. Attach the form node to a Cloudant receiving node and a debug node. 

<img src="../Chapter%201%20-%20Getting%20Started/Screenshots/cloudant_flow.png" >

5. Edit the Cloudant node. 

  - Service: External cloudant or couchdb service
  
  <img src="../Chapter%201%20-%20Getting%20Started/Screenshots/cloudant_edit.png" height="500">
  ...
  - Enter the host, username and password from your Cloudant credentials (listed in the Service Credentials tab on your Cloudant on Bluemix)
    ...
    <img src="../Chapter%201%20-%20Getting%20Started/Screenshots/cloudant_edit2.png" height="500">
...
7. To open the dashboard user interface, copy the your Node Red instance URL, including mybluemix.net, and after the slash, type "ui."
  ...
  <img src="../Chapter%201%20-%20Getting%20Started/Screenshots/form.png">
...
11. Click on your database. 
  ...
  <img src="../Chapter%201%20-%20Getting%20Started/Screenshots/all_dbs.png">

12. To check the document's payload, click on the pen symbol to the right of the document box. 

  <img src="../Chapter%201%20-%20Getting%20Started/Screenshots/db_doc.png">
  
#### Result:

Your form entries are stored in the payload of the document and printed in the Node Red debug console. 

<img src="../Chapter%201%20-%20Getting%20Started/Screenshots/doc_payload.png">

<img src="../Chapter%201%20-%20Getting%20Started/Screenshots/form_debug.png">
